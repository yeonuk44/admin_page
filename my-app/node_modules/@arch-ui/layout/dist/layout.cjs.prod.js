...
const CONTAINER_WIDTH = 1160, CONTAINER_GUTTER = 6 * theme.gridSize, Container = styled.div(({isFullWidth: isFullWidth}) => ({
...
const Grid = _ref2 => {
  let {alignContent: alignContent, areas: areas, columns: columns = 12, flow: flow = "row", gap: gap = 8, justifyContent: justifyContent, minRowHeight: minRowHeight = 20, rows: rows} = _ref2, props = _objectWithoutProperties(_ref2, [ "alignContent", "areas", "columns", "flow", "gap", "justifyContent", "minRowHeight", "rows" ]);
  ...
  let {area: area, height: height = 1, left: left, top: top, width: width = 1} = _ref3, props = _objectWithoutProperties(_ref3, [ "area", "height", "left", "top", "width" ]);
  return core.jsx("div", _extends({
    css: {
