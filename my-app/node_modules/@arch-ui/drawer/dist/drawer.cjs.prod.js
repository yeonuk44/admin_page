...
function ModalDialogComponent({attachTo: attachTo, children: children, closeOnBlanketClick: closeOnBlanketClick, component: component, footer: footer, heading: heading, initialFocus: initialFocus, onClose: onClose, slideInFrom: slideInFrom, width: width, onKeyDown: onKeyDown, transitionState: transitionState, isOpen: isOpen}) {
  let stackIndex = useStackIndex("entered" === transitionState || "entering" === transitionState, slideInFrom);
