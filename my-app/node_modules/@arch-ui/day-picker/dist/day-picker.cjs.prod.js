...
const monthOptions = months.map((month, i) => core.jsx("option", {
  key: i,
  value: i
}, dateFns.format(dateFns.setMonth(new Date, month), "MMM"))), SelectMonth = React.memo(({onChange: onChange, month: month}) => core.jsx("select", {
  id: "ks-select-month",
  onChange: event => {
...
const MonthHeader = React.memo(({month: month, year: year}) => core.jsx("div", {
  css: {
    position: "sticky",
    top: 0,
    width: "100%",
...
const DayPicker = ({yearRangeFrom: yearRangeFrom, yearRangeTo: yearRangeTo, yearPickerType: yearPickerType, startCurrentDateAt: startCurrentDateAt, selectedDate: selectedDate, onSelectedChange: onSelectedChange}) => {
