...
var _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), core = require("@emotion/core"), react = require("react"), ReactSelect = require("react-select"), ReactSelect__default = _interopDefault(ReactSelect), icons = require("@arch-ui/icons"), theme = require("@arch-ui/theme"), common = require("@arch-ui/common");
...
const CheckMark = ({isDisabled: isDisabled, isFocused: isFocused, isSelected: isSelected}) => {
  let bg, fg, border;
...
}, OptionPrimitive = ({children: children, isDisabled: isDisabled, innerProps: innerProps, innerRef: innerRef}) => core.jsx("div", _extends({
  ref: innerRef,
  css: {
    alignItems: "center",
...
}, innerProps), children), optionRendererStyles = {
  ...
  let {selectProps: selectProps} = _ref, props = _objectWithoutProperties(_ref, [ "selectProps" ]);
  ...
  let {displaySearch: displaySearch, innerRef: innerRef, components: propComponents} = _ref2, props = _objectWithoutProperties(_ref2, [ "displaySearch", "innerRef", "components" ]);
