...
const Item = (_ref) => {
  let {
    ...
    isDisabled
      ...
      props = _objectWithoutProperties(_ref, ["children", "icon", "isDisabled"]);
...
class Dropdown extends react.Component {
    ...
    _defineProperty(this, "handleItemClick", (_ref2) => {
      let {
        onClick
          ...
          data = _objectWithoutProperties(_ref2, ["onClick"]);
  ...
  render() {
    ...
    if (attachTo) {
      return reactDom.createPortal(core.jsx(FocusTrap, {
        focusTrapOptions: {
