...
const ItemElement = props => props.to ? core.jsx(reactRouterDom.Link, props) : props.href ? core.jsx("a", props) : core.jsx("button", _extends({
  ...
  let {children: children, icon: icon, isDisabled: isDisabled} = _ref, props = _objectWithoutProperties(_ref, [ "children", "icon", "isDisabled" ]);
...
}, Menu = styled.div(({left: left, top: top}) => {
...
class Dropdown extends react.Component {
  constructor(...args) {
    super(...args), _defineProperty(this, "state", {
      ...
      let {onClick: onClick} = _ref2, data = _objectWithoutProperties(_ref2, [ "onClick" ]);
      return event => {
    ...
    }), _defineProperty(this, "handleMouseEnter", ({target: target}) => {
  ...
  render() {
    ...
    return attachTo ? reactDom.createPortal(core.jsx(FocusTrap, {
      focusTrapOptions: {
