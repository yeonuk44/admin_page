...
var _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), core = require("@emotion/core"), React = require("react"), icons = require("@arch-ui/icons"), layout = require("@arch-ui/layout"), loading = require("@arch-ui/loading"), button = require("@arch-ui/button");
...
class Pagination extends React.Component {
  ...
  renderPages() {
    let {ariaPageLabel: ariaPageLabel, currentPage: currentPage, limit: limit, pageSize: pageSize, total: total} = this.props;
  ...
  render() {
    const _this$props = this.props, rest = _objectWithoutProperties(_this$props, [ "ariaPageLabel", "currentPage", "isLoading", "limit", "onChange", "pageSize", "total" ]);
