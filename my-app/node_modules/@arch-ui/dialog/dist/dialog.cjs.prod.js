...
var _defineProperty = _interopDefault(require("@babel/runtime/helpers/defineProperty")), React = require("react"), React__default = _interopDefault(React), reactDom = require("react-dom"), ScrollLock = _interopDefault(require("react-scrolllock")), FocusTrap = _interopDefault(require("focus-trap-react")), modalUtils = require("@arch-ui/modal-utils"), typography = require("@arch-ui/typography"), _extends = _interopDefault(require("@babel/runtime/helpers/extends")), _objectWithoutProperties = _interopDefault(require("@babel/runtime/helpers/objectWithoutProperties")), core = require("@emotion/core"), styled = _interopDefault(require("@emotion/styled")), theme = require("@arch-ui/theme"), colorUtils = require("@arch-ui/color-utils");

const outerGutter = 40, innerGutter = 20, Positioner = styled.div(({width: width}) => ({
  display: "flex",
  ...
  let {component: Tag} = _ref, props = _objectWithoutProperties(_ref, [ "component" ]);
...
class ModalDialog extends React.PureComponent {
  constructor(...args) {
    super(...args), _defineProperty(this, "onKeyDown", e => {
