...
}, getSelectVariant = ({isAsync: isAsync, isCreatable: isCreatable}) => isAsync && isCreatable ? AsyncCreatableSelect : isAsync ? AsyncSelect : isCreatable ? CreatableSelect : BaseSelect, Select = _ref => {
  let {isAsync: isAsync, isCreatable: isCreatable, innerRef: innerRef, styles: styles} = _ref, props = _objectWithoutProperties(_ref, [ "isAsync", "isCreatable", "innerRef", "styles" ]);
