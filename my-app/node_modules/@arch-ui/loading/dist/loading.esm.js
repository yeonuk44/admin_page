...
const fadeAnim = keyframes(_templateObject());
...
const LoadingIndicator = ({
  appearance,
  size
}) => React.createElement(DotsContainer, {
  size: size
  ...
  delay: 320,
  isOffset: true
}), React.createElement(A11yText, null, "Loading"));
...
const spinAnim = keyframes(_templateObject2());
