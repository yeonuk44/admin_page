...
const fadeAnim = core.keyframes(_templateObject()), appearanceColor = {
  ...
  inverted: "white"
}, DotsContainer = styled.div(({size: size}) => ({
  alignSelf: "center",
  fontSize: size,
  lineHeight: 1,
  textAlign: "center",
  ...
  display: "inline-flex"
})), Dot = styled.span(({appearance: appearance, delay: delay = 0, isOffset: isOffset}) => ({
  ...
  verticalAlign: "top",
  width: "1em"
})), LoadingIndicator = ({appearance: appearance, size: size}) => React.createElement(DotsContainer, {
  size: size
...
const spinAnim = core.keyframes(_templateObject2()), spinnerCommon = ({size: size}) => ({
  borderRadius: "50%",
  borderStyle: "solid",
  borderWidth: size / 8,
  ...
  height: size,
  width: size
}), SpinnerWrapper = styled.div(({size: size}) => ({
  height: size,
  width: size,
  position: "relative"
})), SpinnerOrbit = styled.div(({color: color, size: size}) => _objectSpread({}, spinnerCommon({
  size: size
}), {
  borderColor: color,
  opacity: .2,
  position: "relative"
})), SpinnerSatellite = styled.div(({color: color, size: size}) => _objectSpread({}, spinnerCommon({
  size: size
}), {
  ...
  position: "absolute",
  top: 0
})), LoadingSpinner = ({appearance: appearance, size: size}) => {
