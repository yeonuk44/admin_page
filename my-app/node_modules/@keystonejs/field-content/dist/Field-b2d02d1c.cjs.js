...
var paragraph = require('./paragraph-285c0715.cjs.js');
...
let AddBlock = ({
  ...
  let layout = React.useCallback(() => {
    ...
    if (focusBlock === null || focusBlock.text !== '' || focusBlock.type !== paragraph.type) {
...
let ContentField = ({
  ...
  core.jsx(Provider, {
    ...
    autoFocus: autoFocus,
    id: htmlID,
    css: _objectSpread$1({}, input.inputStyles({
      isMultiline: true
    }), {
      padding: '16px 32px',
      zIndex: 0
