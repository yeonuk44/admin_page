...
import { w as walkSlateNode } from './slate-walker-96c0074f.esm.js';
  ...
  constructor(path, _ref, listConfig) {
    let {
      blocks: inputBlocks
        ...
        fieldConfig = _objectWithoutProperties(_ref, ["blocks"]); // To maintain consistency with other types, we grab the sanitised name
          ...
          async resolveInput(_ref2) {
            let {
              resolvedData
                ...
                args = _objectWithoutProperties(_ref2, ["resolvedData"]); // This method will get called twice;
