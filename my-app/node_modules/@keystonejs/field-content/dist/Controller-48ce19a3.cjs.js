...
require('./slate-walker-8dc9af58.cjs.js');

var slate = require('slate');

require('nanoassert');

var fieldContent = require('../slate-serializer/dist/field-content.cjs.js');

var memoizeOne = _interopDefault(require('memoize-one'));

var isPromise = _interopDefault(require('p-is-promise'));

var Controller = _interopDefault(require('@keystonejs/fields/Controller'));
...
class ContentController extends Controller {
  constructor(config, ...args) {
    const defaultValue = 'defaultValue' in config ? config.defaultValue : slate.Value.fromJSON(initialValue);
    ...
    _defineProperty(this, "serialize", data => {
      ...
      const serializedDocument = fieldContent.serialize(data[path], blocks); // TODO: Make this a JSON type in GraphQL so we don't have to stringify it.
    ...
    _defineProperty(this, "deserialize", data => {
      ...
      return fieldContent.deserialize(parsedData, blocks);
    });

    _defineProperty(this, "getQueryFragment", () => "\n    ".concat(this.path, " {\n      document\n      ").concat(Object.values(this.config.blockOptions).map(({
      query
